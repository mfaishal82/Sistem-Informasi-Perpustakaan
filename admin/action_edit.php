...
$tanggal_diterbitkan = $_POST['tanggal_diterbitkan'];
$harga = $_POST['harga'];

$query = "
update buku set judul_buku='$judul_buku', penulis='$penulis', sinopsis_buku='$sinopsis_buku', tanggal_diterbitkan='$tanggal_diterbitkan', harga='$harga' where id=$id
";
